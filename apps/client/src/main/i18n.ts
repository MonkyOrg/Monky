...
const CATALOGS = {
  'pt-BR': {
    ...
    'localExecution.alwaysHint': 'Mantém a autorização neste dispositivo até você revogá-la.',
  ...
  en: {
    ...
    'localExecution.alwaysHint': 'Keeps authorization on this device until you revoke it.',
