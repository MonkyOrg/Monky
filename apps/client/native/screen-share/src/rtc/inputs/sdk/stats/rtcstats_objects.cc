...
WEBRTC_RTCSTATS_IMPL(
    ...
    AttributeInit("monkyReceiveStreamInstanceId", &monky_receive_stream_instance_id),
    AttributeInit("monkyReceiveStreamSsrc", &monky_receive_stream_ssrc),
    AttributeInit("monkyDecoderTimestampMapOverflowEvictions", &monky_decoder_timestamp_map_overflow_evictions),
    AttributeInit("monkyDecoderTimestampMapMissingCallbacks", &monky_decoder_timestamp_map_missing_callbacks),
    AttributeInit("monkyDecoderTimestampMapSkippedMappings", &monky_decoder_timestamp_map_skipped_mappings),
    AttributeInit("monkyDecoderTimestampMapSkipEvents", &monky_decoder_timestamp_map_skip_events),
    AttributeInit("monkyDecoderTimestampMapClearedMappings", &monky_decoder_timestamp_map_cleared_mappings),
    AttributeInit("monkyDecoderTimestampMapClearEvents", &monky_decoder_timestamp_map_clear_events),
    AttributeInit("monkyDecoderTimestampMapMappedCallbacks", &monky_decoder_timestamp_map_mapped_callbacks),
    AttributeInit("monkyFrameBufferSkippedFrames", &monky_frame_buffer_skipped_frames),
    AttributeInit("monkyFrameBufferSkipEvents", &monky_frame_buffer_skip_events),
    AttributeInit("monkyFrameBufferClearedFrames", &monky_frame_buffer_cleared_frames),
    AttributeInit("monkyFrameBufferClearEvents", &monky_frame_buffer_clear_events),
    AttributeInit("monkyDecoderTimestampMapLeaseRetirements", &monky_decoder_timestamp_map_lease_retirements),
...
WEBRTC_RTCSTATS_IMPL(
    ...
    AttributeInit("monkySendStreamSsrcs", &monky_send_stream_ssrcs),
    AttributeInit("monkyFramesDroppedByEncoderQueue", &monky_frames_dropped_by_encoder_queue),
    AttributeInit("monkyFramesDroppedByRateLimiter", &monky_frames_dropped_by_rate_limiter),
    AttributeInit("monkyFramesDroppedByCongestionWindow", &monky_frames_dropped_by_congestion_window),
    AttributeInit("monkyFramesDroppedByBadTimestamp", &monky_frames_dropped_by_bad_timestamp),
    AttributeInit("monkyFramesDroppedByEncoder", &monky_frames_dropped_by_encoder),
