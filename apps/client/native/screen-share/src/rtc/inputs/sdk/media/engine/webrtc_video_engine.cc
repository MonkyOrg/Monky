...
WebRtcVideoSendChannel::WebRtcVideoSendStream::GetPerLayerVideoSenderInfos(
  ...
  if (stream_ == nullptr) {
    ...
    common_info.monky_send_stream_ssrcs = parameters_.config.rtp.ssrcs;
    common_info.monky_frames_dropped_by_encoder_queue = stats.frames_dropped_by_encoder_queue;
    common_info.monky_frames_dropped_by_rate_limiter = stats.frames_dropped_by_rate_limiter;
    common_info.monky_frames_dropped_by_congestion_window = stats.frames_dropped_by_congestion_window;
    common_info.monky_frames_dropped_by_bad_timestamp = stats.frames_dropped_by_bad_timestamp;
    common_info.monky_frames_dropped_by_encoder = stats.frames_dropped_by_encoder;
    if (log_stats)
...
WebRtcVideoReceiveChannel::WebRtcVideoReceiveStream::GetVideoReceiverInfo(
  ...
  info.monky_receive_stream_instance_id = stats.monky_receive_stream_instance_id;
  info.monky_receive_stream_ssrc = stats.monky_receive_stream_ssrc;
  info.monky_decoder_timestamp_map_overflow_evictions = stats.monky_decoder_timestamp_map_overflow_evictions;
  info.monky_decoder_timestamp_map_missing_callbacks = stats.monky_decoder_timestamp_map_missing_callbacks;
  info.monky_decoder_timestamp_map_skipped_mappings = stats.monky_decoder_timestamp_map_skipped_mappings;
  info.monky_decoder_timestamp_map_skip_events = stats.monky_decoder_timestamp_map_skip_events;
  info.monky_decoder_timestamp_map_cleared_mappings = stats.monky_decoder_timestamp_map_cleared_mappings;
  info.monky_decoder_timestamp_map_clear_events = stats.monky_decoder_timestamp_map_clear_events;
  info.monky_decoder_timestamp_map_mapped_callbacks = stats.monky_decoder_timestamp_map_mapped_callbacks;
  info.monky_frame_buffer_skipped_frames = stats.monky_frame_buffer_skipped_frames;
  info.monky_frame_buffer_skip_events = stats.monky_frame_buffer_skip_events;
  info.monky_frame_buffer_cleared_frames = stats.monky_frame_buffer_cleared_frames;
  info.monky_frame_buffer_clear_events = stats.monky_frame_buffer_clear_events;
  info.monky_decoder_timestamp_map_lease_retirements = stats.monky_decoder_timestamp_map_lease_retirements;
