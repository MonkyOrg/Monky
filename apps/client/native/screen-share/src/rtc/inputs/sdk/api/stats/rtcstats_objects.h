...
#define MONKY_RTC_RECEIVE_DIAGNOSTICS_REVISION 1
...
class RTC_EXPORT RTCInboundRtpStreamStats final
 ...
 public:
  ...
  // Private per-receive-stream diagnostics, not native decoder ownership IDs.
  std::optional<uint64_t> monky_receive_stream_instance_id;
  std::optional<uint32_t> monky_receive_stream_ssrc;
  std::optional<uint64_t> monky_decoder_timestamp_map_overflow_evictions;
  std::optional<uint64_t> monky_decoder_timestamp_map_missing_callbacks;
  std::optional<uint64_t> monky_decoder_timestamp_map_skipped_mappings;
  std::optional<uint64_t> monky_decoder_timestamp_map_skip_events;
  std::optional<uint64_t> monky_decoder_timestamp_map_cleared_mappings;
  std::optional<uint64_t> monky_decoder_timestamp_map_clear_events;
  std::optional<uint64_t> monky_decoder_timestamp_map_mapped_callbacks;
  std::optional<uint64_t> monky_frame_buffer_skipped_frames;
  std::optional<uint64_t> monky_frame_buffer_skip_events;
  std::optional<uint64_t> monky_frame_buffer_cleared_frames;
  std::optional<uint64_t> monky_frame_buffer_clear_events;
  std::optional<uint64_t> monky_decoder_timestamp_map_lease_retirements;
...
#define MONKY_RTC_SEND_DROP_STATS_REVISION 1
...
class RTC_EXPORT RTCOutboundRtpStreamStats final
 ...
 public:
  ...
  // Send-stream aggregates, not per-layer/RTX counts. Missing stays absent.
  std::optional<std::vector<uint32_t>> monky_send_stream_ssrcs;
  std::optional<uint32_t> monky_frames_dropped_by_encoder_queue;
  std::optional<uint32_t> monky_frames_dropped_by_rate_limiter;
  std::optional<uint32_t> monky_frames_dropped_by_congestion_window;
  std::optional<uint32_t> monky_frames_dropped_by_bad_timestamp;
  std::optional<uint32_t> monky_frames_dropped_by_encoder;
