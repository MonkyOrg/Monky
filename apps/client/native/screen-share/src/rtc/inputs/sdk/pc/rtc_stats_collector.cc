...
CreateInboundRTPStreamStatsFromVideoReceiverInfo(
  ...
  inbound_video->monky_receive_stream_instance_id = video_receiver_info.monky_receive_stream_instance_id;
  inbound_video->monky_receive_stream_ssrc = video_receiver_info.monky_receive_stream_ssrc;
  inbound_video->monky_decoder_timestamp_map_overflow_evictions = video_receiver_info.monky_decoder_timestamp_map_overflow_evictions;
  inbound_video->monky_decoder_timestamp_map_missing_callbacks = video_receiver_info.monky_decoder_timestamp_map_missing_callbacks;
  inbound_video->monky_decoder_timestamp_map_skipped_mappings = video_receiver_info.monky_decoder_timestamp_map_skipped_mappings;
  inbound_video->monky_decoder_timestamp_map_skip_events = video_receiver_info.monky_decoder_timestamp_map_skip_events;
  inbound_video->monky_decoder_timestamp_map_cleared_mappings = video_receiver_info.monky_decoder_timestamp_map_cleared_mappings;
  inbound_video->monky_decoder_timestamp_map_clear_events = video_receiver_info.monky_decoder_timestamp_map_clear_events;
  inbound_video->monky_decoder_timestamp_map_mapped_callbacks = video_receiver_info.monky_decoder_timestamp_map_mapped_callbacks;
  inbound_video->monky_frame_buffer_skipped_frames = video_receiver_info.monky_frame_buffer_skipped_frames;
  inbound_video->monky_frame_buffer_skip_events = video_receiver_info.monky_frame_buffer_skip_events;
  inbound_video->monky_frame_buffer_cleared_frames = video_receiver_info.monky_frame_buffer_cleared_frames;
  inbound_video->monky_frame_buffer_clear_events = video_receiver_info.monky_frame_buffer_clear_events;
  inbound_video->monky_decoder_timestamp_map_lease_retirements = video_receiver_info.monky_decoder_timestamp_map_lease_retirements;
...
CreateOutboundRTPStreamStatsFromVideoSenderInfo(
  ...
  outbound_video->monky_send_stream_ssrcs = video_sender_info.monky_send_stream_ssrcs;
  outbound_video->monky_frames_dropped_by_encoder_queue = video_sender_info.monky_frames_dropped_by_encoder_queue;
  outbound_video->monky_frames_dropped_by_rate_limiter = video_sender_info.monky_frames_dropped_by_rate_limiter;
  outbound_video->monky_frames_dropped_by_congestion_window = video_sender_info.monky_frames_dropped_by_congestion_window;
  outbound_video->monky_frames_dropped_by_bad_timestamp = video_sender_info.monky_frames_dropped_by_bad_timestamp;
  outbound_video->monky_frames_dropped_by_encoder = video_sender_info.monky_frames_dropped_by_encoder;
