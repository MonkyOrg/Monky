...
// rendered.
// Private diagnostics: decoded-event frames count skipped older mappings.
enum class MonkyDecoderTimestampMapEvent {
  kOverflowEviction, kMissingCallback, kMappedCallback, kClear, kLeaseRetirement
};
...
class VCMReceiveCallback {
 public:
  ...
  virtual void OnMonkyDecoderTimestampMap(MonkyDecoderTimestampMapEvent event,
                                         uint32_t frames);
