...
function generateNotices() {
  ...
  write(path.join(root, 'THIRD_PARTY_NOTICES'), [
    ...
    '',
    'OBS Studio 32.1.1 (GPL-2.0-or-later), its WGC capture module and runtime are included.',
    'The capture module has Monky changes for WGC-only startup without game hooks or updater workers.',
