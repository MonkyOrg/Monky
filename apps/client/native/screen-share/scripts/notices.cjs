...
function generateNotices() {
  ...
  write(path.join(root, 'THIRD_PARTY_NOTICES'), [
    ...
    'H.264 software encoding uses x264; AV1 software encoding uses libaom and native AV1 decoding uses dav1d.',
    'The WebRTC notices are generated from the dependencies of the actual compiled GN targets.',
