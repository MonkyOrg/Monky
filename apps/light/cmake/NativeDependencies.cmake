...
set(MONKY_FIELD_TRIALS_ENCODED
  "${CMAKE_CURRENT_SOURCE_DIR}/build/downloads/${MONKY_SDK_TARGET}/field_trials-${MONKY_FIELD_TRIALS_sha256}.base64")
set(MONKY_FIELD_TRIALS_SOURCE "${MONKY_WEBRTC_EXTRA_DIRECTORY}/field_trials.cc")
monky_download_verified("${MONKY_FIELD_TRIALS_url}" "${MONKY_FIELD_TRIALS_ENCODED}" "${MONKY_FIELD_TRIALS_sha256}")
